...
while True:
    ...
    ret, frame_camera = capture.read()     # 카메라로부터 현재 영상을 받아 frame에 저장, 잘 받았다면 ret가 참
    frame = cv2.cvtColor(frame_camera, cv2.COLOR_BGR2GRAY)
    ...
    draw.text(xy=(10, 15),  text="이지태 웹캠 "+nowDatetime, font=font, fill=(255, 255, 255))
