...
def getCircleCenter(p1 = [], p2 = [], p3 = []) :
    ...
    # plt.scatter(dx1,dy1,s=10,c='magenta')                                                
    
    dx2 = p3[0] - p2[0]
    dy2 = p3[1] - p2[1]
    
    # plt.scatter(dx2,dy2,s=10,c='magenta')
...
#                plt.scatter(dx1p,dy1p,s=10,c='magenta')
#                plt.scatter(dx2p,dy2p,s=10,c='magenta')                
    ...
    # plt.scatter(mx1,my1,s=10,c='magenta')
    # plt.scatter(mx2,my2,s=10,c='magenta')                
    ...
    # plt.scatter(mx1n,my1n,s=10,c='magenta')
    # plt.scatter(mx2n,my2n,s=10,c='magenta')                

    
    arc = lineLineIntersection_8(mx1, my1, mx1n, my1n, mx2, my2, mx2n, my2n) # 두점
    r = dist(arc,p1) #반지름 R
    
    # plt.scatter(arc[0],arc[1],s=10,c='magenta')                
    ...
    pac = mpatches.Arc(arc, r, r, angle=0, theta1=e/PI * 180, theta2=s/PI * 180)
    circle = plt.Circle(arc,r,fill=False)
...
while not(done) or not(end_flag) :
    ...
    if done or step > 200:
        if te > 1 :        
            Curve_End = Bezier.Curve([1],points_set_1)
            np3 = Curve_End[0]
            arc = getCircleCenter(np1 , np2 , np3)
    ...
    if currGood :
        ...
        #plt.scatter(arc[0],arc[1],s=10,c='magenta') # 중간점 
...
plt.xlabel('X-Axis')
plt.ylabel('Y-Axis')
plt.xlim([0, 330])      # X축의 범위: [xmin, xmax]
plt.ylim([150, 330])     # Y축의 범위: [ymin, ymax]
